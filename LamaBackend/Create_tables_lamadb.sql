...
CONSTRAINT loan_employee_constraint FOREIGN KEY(loan_id) REFERENCES loan_card_master(loan_id));
...
CONSTRAINT item_loan_card_constraint_2 FOREIGN KEY(loan_id) REFERENCES loan_card_master(loan_id));
